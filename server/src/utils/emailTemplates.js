const APP_NAME = process.env.APP_NAME || 'LabSense';
...
export const generateVerificationEmailHTML = (name, verificationUrl) => {
...
export const generatePasswordResetEmailHTML = (name, resetUrl) => {
    const safeName = escapeHTML(name);
    const content = `
        <p>Hi ${safeName},</p>
